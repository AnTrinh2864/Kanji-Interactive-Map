...
katakana = [
    ...
    {"char": "ツ", "romaji": "tu", "type": "katakana"},
    ...
    {"char": "フ", "romaji": "hu", "type": "katakana"},
    ...
    {"char": "ユ", "romaji": "yo", "type": "katakana"},
    {"char": "ヨ", "romaji": "yu", "type": "katakana"},
    ...
    {"char": "ㇺ", "romaji": "mu", "type": "katakana"},
    {"char": "メ", "romaji": "me", "type": "katakana"},
    {"char": "モ", "romaji": "mo", "type": "katakana"},
    {"char": "ダ", "romaji": "da", "type": "katakana"},
    {"char": "ヂ", "romaji": "di", "type": "katakana"},
    {"char": "ヅ", "romaji": "du", "type": "katakana"},
    ...
    {"char": "キャ", "romaji": "kya", "type": "katakana"},
    {"char": "キュ", "romaji": "kyu", "type": "katakana"},
    {"char": "キョ", "romaji": "kyo", "type": "katakana"},
    {"char": "ギャ", "romaji": "gya", "type": "katakana"},
    {"char": "ギュ", "romaji": "gyu", "type": "katakana"},
    {"char": "ギョ", "romaji": "gyo", "type": "katakana"},
    {"char": "シャ", "romaji": "sha", "type": "katakana"},
    {"char": "シュ", "romaji": "shu", "type": "katakana"},
    {"char": "ショ", "romaji": "sho", "type": "katakana"},
    {"char": "チャ", "romaji": "cha", "type": "katakana"},
    {"char": "チュ", "romaji": "chu", "type": "katakana"},
    {"char": "チョ", "romaji": "cho", "type": "katakana"},
    {"char": "ニャ", "romaji": "nya", "type": "katakana"},
    {"char": "ニュ", "romaji": "nyu", "type": "katakana"},
    {"char": "ニョ", "romaji": "nyo", "type": "katakana"},
    {"char": "ヒャ", "romaji": "hya", "type": "katakana"},
    {"char": "ヒュ", "romaji": "hyu", "type": "katakana"},
    {"char": "ヒョ", "romaji": "hyo", "type": "katakana"},
    {"char": "ミャ", "romaji": "mya", "type": "katakana"},
    {"char": "ミュ", "romaji": "myu", "type": "katakana"},
    {"char": "ミョ", "romaji": "myo", "type": "katakana"},
    {"char": "リャ", "romaji": "rya", "type": "katakana"},
    {"char": "リュ", "romaji": "ryu", "type": "katakana"},
    {"char": "リョ", "romaji": "ryo", "type": "katakana"},
    {"char": "ビャ", "romaji": "bya", "type": "katakana"},
    {"char": "ビュ", "romaji": "byu", "type": "katakana"},
    {"char": "ビョ", "romaji": "byo", "type": "katakana"},
    {"char": "ジャ", "romaji": "ja", "type": "katakana"},
    {"char": "ジュ", "romaji": "ju", "type": "katakana"},
    {"char": "ジョ", "romaji": "jo", "type": "katakana"},
    {"char": "ピャ", "romaji": "pya", "type": "katakana"},
    {"char": "ピュ", "romaji": "pyu", "type": "katakana"},
    {"char": "ピョ", "romaji": "pyo", "type": "katakana"},
]
hiragana = [
    ...
    {"char": "ふ", "romaji": "hu", "type": "hiragana"},
    ...
    {"char": "ゆ", "romaji": "yo", "type": "hiragana"},
    {"char": "よ", "romaji": "yu", "type": "hiragana"},
    ...
    {"char": "きゃ", "romaji": "kya", "type": "hiragana"},
    {"char": "きゅ", "romaji": "kyu", "type": "hiragana"},
    {"char": "きょ", "romaji": "kyo", "type": "hiragana"},
    {"char": "ぎゃ", "romaji": "gya", "type": "hiragana"},
    {"char": "ぎゅ", "romaji": "gyu", "type": "hiragana"},
    {"char": "ぎょ", "romaji": "gyo", "type": "hiragana"},
    {"char": "しゃ", "romaji": "sha", "type": "hiragana"},
    {"char": "しゅ", "romaji": "shu", "type": "hiragana"},
    {"char": "しょ", "romaji": "sho", "type": "hiragana"},
    {"char": "ちゃ", "romaji": "cha", "type": "hiragana"},
    {"char": "ちゅ", "romaji": "chu", "type": "hiragana"},
    {"char": "ちょ", "romaji": "cho", "type": "hiragana"},
    {"char": "にゃ", "romaji": "nya", "type": "hiragana"},
    {"char": "にゅ", "romaji": "nyu", "type": "hiragana"},
    {"char": "にょ", "romaji": "nyo", "type": "hiragana"},
    {"char": "ひゃ", "romaji": "hya", "type": "hiragana"},
    {"char": "ひゅ", "romaji": "hyu", "type": "hiragana"},
    {"char": "ひょ", "romaji": "hyo", "type": "hiragana"},
    {"char": "みゃ", "romaji": "mya", "type": "hiragana"},
    {"char": "みゅ", "romaji": "myu", "type": "hiragana"},
    {"char": "みょ", "romaji": "myo", "type": "hiragana"},
    {"char": "りゃ", "romaji": "rya", "type": "hiragana"},
    {"char": "りゅ", "romaji": "ryu", "type": "hiragana"},
    {"char": "りょ", "romaji": "ryo", "type": "hiragana"},
    {"char": "びゃ", "romaji": "bya", "type": "hiragana"},
    {"char": "びゅ", "romaji": "byu", "type": "hiragana"},
    {"char": "びょ", "romaji": "byo", "type": "hiragana"},
    {"char": "じゃ", "romaji": "ja", "type": "hiragana"},
    {"char": "じゅ", "romaji": "ju", "type": "hiragana"},
    {"char": "じょ", "romaji": "jo", "type": "hiragana"},
    {"char": "ぴゃ", "romaji": "pya", "type": "hiragana"},
    {"char": "ぴゅ", "romaji": "pyu", "type": "hiragana"},
    {"char": "ぴょ", "romaji": "pyo", "type": "hiragana"},
]
# insert both hiragana and katakana
kana_collection.insert_many(hiragana + katakana)
